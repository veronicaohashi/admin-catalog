...
class VideoValidatorTest {
    ...
    @Test
    void givenNullTitle_whenCallsValidate_thenReceiveError() {
    ...
    @Test
    void givenEmptyTitle_whenCallsValidate_thenReceiveError() {
    ...
    @Test
    void givenTitleWithLengthGreaterThan255_whenCallsValidate_thenReceiveError(){
    ...
    @Test
    void givenEmptyDescription_whenCallsValidate_thenReceiveError() {
    ...
    @Test
    void givenDescriptionWithLengthGreaterThan4000_whenCallsValidate_thenReceiveError() {
    ...
    @Test
    void givenNullLaunchedAt_whenCallsValidate_thenReceiveError() {
    ...
    @Test
    void givenNullRating_whenCallsValidate_thenReceiveError() {
